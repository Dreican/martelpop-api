...
class EventResponseFactory(ResponseFactory[Event, EventSummaryResponse]):
    def __init__(
            self,
        ...
        self._activity_type_summary_factory = activity_type_summary_factory
    ...
    def create(self, entity: Event) -> EventSummaryResponse:
        ...
        response.activity_type = self._activity_type_summary_factory.create(entity.activity_type)
