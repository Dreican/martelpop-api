...
async def upload_file(service: FileServiceDep, file: UploadFile = File(...), principal: AuthenticatedPrincipal = authenticated_permission()) -> StoredFileResponse:
...
async def delete_file(file_id: UUID, service: FileServiceDep, principal: AuthenticatedPrincipal = authenticated_permission()) -> None:
