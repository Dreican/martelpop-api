...
async def get_events(event_id: UUID, event_service: EventServiceDep,
...
async def create_event(event: EventCreateRequest, event_service: EventServiceDep,
...
async def update_event(event_id: UUID, event: EventUpdateRequest, event_service: EventServiceDep,
...
async def publish_event(event_id: UUID, event_service: EventServiceDep,
...
async def unpublish_event(event_id: UUID, event_service: EventServiceDep,
                          principal: AuthenticatedPrincipal = authenticated_permission(PermissionCode.EVENT_PUBLISH)):
...
async def cancel_event(event_id: UUID, event_service: EventServiceDep,
...
async def complete_event(event_id: UUID, event_service: EventServiceDep,
                         principal: AuthenticatedPrincipal = authenticated_permission(PermissionCode.EVENT_PUBLISH)):
