...
Revision ID: 8e050b1d21e2
Revises: 
Create Date: 2026-08-01 14:43:58.422556
...
def upgrade() -> None:
    ...
    sa.Column('code', sa.Enum('Draft', 'Published', 'Cancelled', 'Completed', name='eventstatuscode', native_enum=False), nullable=False),
    ...
    sa.Column('provider', sa.Enum('LOCAL', 'GOOGLE', 'FACEBOOK', name='authprovider', native_enum=False), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_event_statuses_code'), table_name='event_statuses')
