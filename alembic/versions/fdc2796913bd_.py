...
Revision ID: fdc2796913bd
Revises: 
Create Date: 2026-07-10 10:38:00.864593
...
def upgrade() -> None:
    ...
    op.create_table('users',
                    ...
                    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='user_status'), server_default='ACTIVE',
                              nullable=False),
                    sa.Column('role_id', sa.Uuid(), nullable=False),
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'),
    ...
    op.create_index(op.f('ix_authentication_identities_provider'), 'authentication_identities', ['provider'],
                    unique=False)
    op.create_index(op.f('ix_authentication_identities_user_id'), 'authentication_identities', ['user_id'],
                    unique=False)
    ...
    op.create_table('registrations',
                    ...
                    sa.Column('status',
                              sa.Enum('PENDING', 'REGISTERED', 'CANCELLED', 'WAITLISTED', name='registrationstatus'),
                              nullable=False),
